...
Original file is located at
    https://colab.research.google.com/drive/1a7ewQmmsB3Cl-0NUej-OZ4AIIemPg6NF
...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        # self.conv11 = nn.Conv2d(8, 8, 3, padding=1, padding_mode='reflect')
        self.conv2 = nn.Conv2d(8, 16, 3, padding=1)
        # self.conv22 = nn.Conv2d(16, 16, 3, padding=1, padding_mode='reflect')
        self.conv3 = nn.Conv2d(16, 32, 3, padding=1)
        # self.conv33 = nn.Conv2d(32, 32, 3, padding=1, padding_mode='reflect')
        self.conv4 = nn.Conv2d(32, 64, 3, padding=1)
        # self.conv44 = nn.Conv2d(64, 64, 3, padding=1, padding_mode='reflect')
    ...
    def forward(self, x):
        ...
        # # TODO: define your model here
        # x = F.relu(self.conv1(x)) # 32-3+1 = 30
        # # x = F.relu(self.conv11(x))
        # # x = F.relu(self.conv11(x))
        # # x = F.relu(self.conv11(x))
        # x = self.bn1(x)
        # x = F.relu(self.conv2(x)) # 30-3+1 = 28
        ...
        # # x = F.relu(self.conv33(x))
        # x = self.bn3(x)
        # x = F.relu(self.conv4(x)) # 12-3+1 = 10
