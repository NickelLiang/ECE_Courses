...
`endif
	...
	wire [11:0] sub_wire7;
	wire [3:0] sub_wire6 = datab_2[3:0];
	wire [3:0] sub_wire5 = datab_1[3:0];
	wire [7:0] sub_wire0 = dataa_0[7:0];
	wire [23:0] sub_wire1 = {sub_wire2, sub_wire2, sub_wire0};
	wire [3:0] sub_wire3 = datab_0[3:0];
	wire [11:0] sub_wire4 = {sub_wire6, sub_wire5, sub_wire3};
	wire [11:0] result = sub_wire7[11:0];
...
// Retrieval info: PRIVATE: RNFORMAT STRING "12"
...
// Retrieval info: USED_PORT: datab_2 0 0 4 0 INPUT GND "datab_2[3..0]"
...
// Retrieval info: CONNECT: @datab 0 0 4 8 datab_2 0 0 4 0
