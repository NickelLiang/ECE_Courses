...
% ================================================================================
% Generated on: 12/14/2018 16:42:56
...
for j = 1:sx
    ...
    %
    file_name = ['Lowpass_Filter_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = Lowpass_Filter_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['Lowpass_Filter_model_output'];
