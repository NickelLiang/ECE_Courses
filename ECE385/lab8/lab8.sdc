...
set_false_path -from * -to [get_ports {OTG_DATA[0]}]
set_false_path -from * -to [get_ports {OTG_DATA[1]}]
set_false_path -from * -to [get_ports {OTG_DATA[2]}]
set_false_path -from * -to [get_ports {OTG_DATA[3]}]
set_false_path -from * -to [get_ports {OTG_DATA[4]}]
set_false_path -from * -to [get_ports {OTG_DATA[5]}]
set_false_path -from * -to [get_ports {OTG_DATA[6]}]
set_false_path -from * -to [get_ports {OTG_DATA[7]}]
set_false_path -from * -to [get_ports {OTG_DATA[8]}]
set_false_path -from * -to [get_ports {OTG_DATA[9]}]
set_false_path -from * -to [get_ports {OTG_DATA[10]}]
set_false_path -from * -to [get_ports {OTG_DATA[11]}]
set_false_path -from * -to [get_ports {OTG_DATA[12]}]
set_false_path -from * -to [get_ports {OTG_DATA[13]}]
set_false_path -from * -to [get_ports {OTG_DATA[14]}]
set_false_path -from * -to [get_ports {OTG_DATA[15]}]
...
set_false_path -from * -to [get_ports {VGA_R[0]}]
set_false_path -from * -to [get_ports {VGA_R[1]}]
set_false_path -from * -to [get_ports {VGA_R[2]}]
set_false_path -from * -to [get_ports {VGA_R[3]}]
set_false_path -from * -to [get_ports {VGA_R[4]}]
set_false_path -from * -to [get_ports {VGA_R[5]}]
set_false_path -from * -to [get_ports {VGA_R[6]}]
set_false_path -from * -to [get_ports {VGA_R[7]}]
set_false_path -from * -to [get_ports {VGA_G[0]}]
set_false_path -from * -to [get_ports {VGA_G[1]}]
set_false_path -from * -to [get_ports {VGA_G[2]}]
set_false_path -from * -to [get_ports {VGA_G[3]}]
set_false_path -from * -to [get_ports {VGA_G[4]}]
set_false_path -from * -to [get_ports {VGA_G[5]}]
set_false_path -from * -to [get_ports {VGA_G[6]}]
set_false_path -from * -to [get_ports {VGA_G[7]}]
set_false_path -from * -to [get_ports {VGA_B[0]}]
set_false_path -from * -to [get_ports {VGA_B[1]}]
set_false_path -from * -to [get_ports {VGA_B[2]}]
set_false_path -from * -to [get_ports {VGA_B[3]}]
set_false_path -from * -to [get_ports {VGA_B[4]}]
set_false_path -from * -to [get_ports {VGA_B[5]}]
set_false_path -from * -to [get_ports {VGA_B[6]}]
set_false_path -from * -to [get_ports {VGA_B[7]}]
set_false_path -from * -to [get_ports {OTG_ADDR[0]}]
set_false_path -from * -to [get_ports {OTG_ADDR[1]}]
set_false_path -from * -to [get_ports {OTG_CS_N}]
set_false_path -from * -to [get_ports {OTG_RD_N}]
set_false_path -from * -to [get_ports {OTG_RST_N}]
set_false_path -from * -to [get_ports {OTG_WR_N}]
