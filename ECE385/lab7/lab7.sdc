...
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {SW[16]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[16]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {SW[17]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[17]}]
...
set_false_path -from * -to [get_ports {LEDR[0]}]
set_false_path -from * -to [get_ports {LEDR[1]}]
set_false_path -from * -to [get_ports {LEDR[2]}]
set_false_path -from * -to [get_ports {LEDR[3]}]
set_false_path -from * -to [get_ports {LEDR[4]}]
set_false_path -from * -to [get_ports {LEDR[5]}]
set_false_path -from * -to [get_ports {LEDR[6]}]
set_false_path -from * -to [get_ports {LEDR[7]}]
set_false_path -from * -to [get_ports {LEDR[8]}]
set_false_path -from * -to [get_ports {LEDR[9]}]
set_false_path -from * -to [get_ports {LEDR[10]}]
set_false_path -from * -to [get_ports {LEDR[11]}]
set_false_path -from * -to [get_ports {LEDR[12]}]
set_false_path -from * -to [get_ports {LEDR[13]}]
set_false_path -from * -to [get_ports {LEDR[14]}]
set_false_path -from * -to [get_ports {LEDR[15]}]
set_false_path -from * -to [get_ports {LEDR[16]}]
set_false_path -from * -to [get_ports {LEDR[17]}]
...
set_false_path -from * -to [get_ports {SW[0]}]
set_false_path -from * -to [get_ports {SW[1]}]
set_false_path -from * -to [get_ports {SW[2]}]
set_false_path -from * -to [get_ports {SW[3]}]
set_false_path -from * -to [get_ports {SW[4]}]
set_false_path -from * -to [get_ports {SW[5]}]
set_false_path -from * -to [get_ports {SW[6]}]
set_false_path -from * -to [get_ports {SW[7]}]
set_false_path -from * -to [get_ports {SW[8]}]
set_false_path -from * -to [get_ports {SW[9]}]
set_false_path -from * -to [get_ports {SW[10]}]
set_false_path -from * -to [get_ports {SW[11]}]
set_false_path -from * -to [get_ports {SW[12]}]
set_false_path -from * -to [get_ports {SW[13]}]
set_false_path -from * -to [get_ports {SW[14]}]
set_false_path -from * -to [get_ports {SW[15]}]
set_false_path -from * -to [get_ports {SW[16]}]
set_false_path -from * -to [get_ports {SW[17]}]
