...
module nios_system_mm_interconnect_0 (
	...
	wire   [10:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> aes_decryption_core_0_AES_Slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sdram_s1_agent:cp_channel
	...
	wire   [28:0] led_red_s1_agent_m0_address;                                                        // led_red_s1_agent:m0_address -> led_red_s1_translator:uav_address
	...
	wire  [107:0] led_red_s1_agent_rf_source_data;                                                    // led_red_s1_agent:rf_source_data -> led_red_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] led_red_s1_agent_rsp_fifo_out_data;                                                 // led_red_s1_agent_rsp_fifo:out_data -> led_red_s1_agent:rf_sink_data
	...
	wire          cmd_mux_009_src_valid;                                                              // cmd_mux_009:src_valid -> led_red_s1_agent:cp_valid
	wire  [106:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> led_red_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                              // led_red_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [10:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> led_red_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                                      // cmd_mux_009:src_startofpacket -> led_red_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                        // cmd_mux_009:src_endofpacket -> led_red_s1_agent:cp_endofpacket
	...
	wire  [106:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> timer_0_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                              // timer_0_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [10:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire          led_red_s1_agent_rp_valid;                                                          // led_red_s1_agent:rp_valid -> router_011:sink_valid
	wire  [106:0] led_red_s1_agent_rp_data;                                                           // led_red_s1_agent:rp_data -> router_011:sink_data
	wire          led_red_s1_agent_rp_ready;                                                          // router_011:sink_ready -> led_red_s1_agent:rp_ready
	wire          led_red_s1_agent_rp_startofpacket;                                                  // led_red_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          led_red_s1_agent_rp_endofpacket;                                                    // led_red_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [106:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_012:sink_data
	...
	wire   [10:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> cmd_mux_005:sink1_channel
	...
	wire   [10:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> rsp_mux_001:sink3_channel
	...
	wire   [10:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser_001:in_channel
	...
	wire   [10:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_007:sink1_channel
	...
	wire   [10:0] rsp_demux_007_src0_channel;                                                         // rsp_demux_007:src0_channel -> crosser_002:in_channel
	...
	wire   [10:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink7_channel
	...
	wire   [10:0] rsp_demux_007_src1_channel;                                                         // rsp_demux_007:src1_channel -> crosser_003:in_channel
	...
	wire   [10:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink4_channel
	...
	wire          led_red_s1_agent_rdata_fifo_src_valid;                                              // led_red_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] led_red_s1_agent_rdata_fifo_src_data;                                               // led_red_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          led_red_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_009:in_0_ready -> led_red_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                  // avalon_st_adapter_009:out_0_valid -> led_red_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                                   // avalon_st_adapter_009:out_0_data -> led_red_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                  // led_red_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                  // avalon_st_adapter_009:out_0_error -> led_red_s1_agent:rdata_fifo_sink_error
